...
ALLOWED_HOSTS = [
    "rest-handson-prod.apigateway.in",
    "rest-handson-alpha.apigateway.in",
    "rest-handson-beta.apigateway.in",
    "rest-handson-gamma.apigateway.in",
    "rest-handson-staging.apigateway.in",
    "127.0.0.1",
    "localhost"
]
...
LOGGING = {
    ...
    'formatters': {
        ...
        'console': {
            'format': "[%(request_id)s] [rest_handson - "+os.environ.get("STAGE", "local")+
...
# ****************** App Source Config ******************
REST_HANDSON_SOURCE = "rest-handson-source"
